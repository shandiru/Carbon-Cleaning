      ...
      <div className="relative group">
        ...
        {photos.length > 1 && (
          <>
            <button 
              onClick={prevSlide}
              className="absolute left-4 top-1/2 -translate-y-1/2 bg-black/60 hover:bg-[#B62025]  text-white p-3 rounded-full backdrop-blur-md transition-all z-20 opacity-0 group-hover:opacity-100 shadow-xl"
            ...
            <button 
              onClick={nextSlide}
              className="absolute right-4 top-1/2 -translate-y-1/2 bg-black/60 hover:bg-[#B62025]  text-white p-3 rounded-full backdrop-blur-md transition-all z-20 opacity-0 group-hover:opacity-100 shadow-xl"
